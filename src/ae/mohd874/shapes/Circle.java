...
public class Circle extends Entity implements Shape {
    ...
    public List<PVector> checkCollision(Collidable n) {
        ...
        for (PVector p : isLineIntersect((Line) n))
            list.add(p);
    ...
    private PVector[] isLineIntersect(Line line) {
        return isLineIntersect(line.p1.x, line.p1.y, line.p2.x, line.p2.y, x,
                y, r);
    }
    
    private PVector[] isLineIntersect(float x1, float y1, float x2, float y2,
