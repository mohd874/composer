...
public class Line extends Entity implements Shape, Collidable {
    ...
    public Line(Composer ps, PVector _p1, PVector _p2) {
        super(ps);
        p1 = _p1;
        p2 = _p2;
    }
    
    Line(Composer ps, float x1, float y1, float x2, float y2) {
        this(ps, new PVector(x1, y1), new PVector(x2, y2));
    }
    
    public void display() {
        ps.pushStyle();
        ps.line(p1.x, p1.y, p2.x, p2.y);
        ps.fill(200, 0, 0);
        ps.ellipse(p1.x, p1.y, 5, 5);
        ps.fill(0, 200, 0);
        ps.ellipse(p2.x, p2.y, 5, 5);
        ps.popStyle();
    }
    ...
    PVector intersectionPoint(Line other) {
        return intersectionPoint(p1.x, p1.y, p2.x, p2.y, other.p1.x,
                other.p1.y, other.p2.x, other.p2.y);
    }
    
    private PVector intersectionPoint(float x1, float y1, float x2, float y2,
